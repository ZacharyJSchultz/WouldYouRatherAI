...
function WouldYouRather() {
  ...
  */
  ...
  const handleClick = async (buttonNum: Number) => {
    ...
    await fetch("https://wouldyouratherai.online/update-question-count", {
      method: "PATCH",
      headers: {
  ...
  const generateNewQuestion = () => {
    ...
    fetch("https://wouldyouratherai.online/generate-question")
    .then((res) => {
      if(!res.ok)
  ...
  useEffect(() => {
    ...
    fetch('https://wouldyouratherai.online/get-questions')
    .then((res) => {
      if(!res.ok)
